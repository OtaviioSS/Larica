...
<div class="container mt4">
    <div class="row mt-4 mb-4">
        <a type="button" class="btn-info btn-sm ml-3" href="<%= pag%>.jsp?funcao=novo">Novo Cliente</a>
                    ...
                    if (request.getParameter(
                        ...
                        try {
                            ...
                            while (rs.next()) {
                                ...
                                uf = rs.getString(8);
                                telefone = rs.getString(9);
                                imagem = rs.getString(10);
                            }
                        } catch (Exception e) {
                            out.print(e);
                        }
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input value="<%=email%>" type="email" class="form-control" id="txtemail" name="txtemail">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="validationCustom01">CPF</label>
                            <input value="<%=cpf%>" type="text" class="form-control" id="txtcpf" name="txtcpf">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputAddress">Endereço</label>
                        <input  value="<%=endereco%>" type="text" class="form-control" id="txtendereco" name="txtendereco" placeholder="Rua da Saúde, Cajazeiras">
                    </div>
                    <div class="form-group">
                        <label for="inputAddress2">Nome</label>
                        <input value="<%=nome%>" type="text" class="form-control" id="txtnome" name="txtnome" placeholder="Tauane Souza">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputCity">Cidade</label>
                            <input value="<%=cidade%>" type="text" class="form-control" id="txtcidade" name="txtcidade">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="validationCustom01">Telefone</label>
                            <input value="<%=telefone%>" type="text" class="form-control" id="txttelefone" name="txttelefone">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="inputZip">UF</label>
                            <input value="<%=uf%>" type="text" class="form-control" id="txtuf" name="txtuf">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="validationCustom01">CEP</label>
                            <input value="<%=cep%>" type="text" class="form-control" id="txtcep" name="txtcep">
                        </div>
                    </div>
                    ...
                    <div> 
                        ...
                        <div align="center" class="mb-2">
                            <img src="img/<%=imagem%>" alt="Carregue seu Ficheiro" id="target" width="130" height="130">
                        </div>
                    </div>
                </div>
...
<!-- SCRIPT PARA SUBIR IMAGEM PARA SERVIDOR-->
...
<!-- AJAX VEM DO JAVASCRIPT, É UMA LINGUAGEM UNICA-->
