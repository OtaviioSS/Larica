<%-- 
    Document   : produtos
    Created on : 08/11/2020, 14:02:40
    Author     : CJads
--%>
...
<div class="container mt-4">
    <div class="row mt-4 mb-4">
        <a type="button" class="btn-info btn-sm ml-3" href="<%= pag%>.jsp?funcao=novo">Nova Produto</a>
        <form class="form-inline my-2 my-lg-0 direita" method="get">
            <input class="form-control form-control-sm mr-sm-2" type="search" id="txtbuscar" name="txtbuscar" placeholder="Nº Produto" aria-label="Search">
            ...
            <form id="form" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<%=quantidade%>" type="text" class="form-control" id="quantidade" name="quantidade" placeholder="Quantidade">
                    </div>

                    <div class="form-group">
                        <label>Preço</label>
                        <input  value="<%=preco%>" type="text" class="form-control" id="preco" name="preco" placeholder="Preço">
                    </div>

                    <div class="form-group">
                        <label>Numero</label>
                        <input  value="<%=numero%>" type="text" class="form-control" id="numero" name="numero" placeholder="Numero do Produto">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input value="<%=numero%>" type="hidden" name="antigo" id="antigo">
